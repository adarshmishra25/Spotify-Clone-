...
async function main() {
    ...
    songs.forEach(song => {
        ...
        <li>
            <div style="display:flex;align-items:center;">
                <img class="cover" src="${getCover(song)}" width="50" height="50">
    ...
    CurrentSong.addEventListener("timeupdate", () => {
        ...
        time.innerHTML = `${Timing(CurrentSong.currentTime)} / ${Timing(CurrentSong.duration)}`;
    });
    ...
    volumeSlider.addEventListener("input", function () {
        ...
        vol.src =
            this.value == 0 ? "images/volumeoff.svg" :
            this.value < 0.5 ? "images/vollow.svg" :
            "images/volume.svg";
    });
